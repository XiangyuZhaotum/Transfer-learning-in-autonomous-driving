...
train_imagepath_txtpath_dict = {"city street":"./" + "train_daytime_clear_" + "city_street" + ".txt",
                                "highway":"./" + "train_daytime_clear_" + "highway" + ".txt",
                                "residential":"./" + "train_daytime_clear_" + "residential" + ".txt"}
