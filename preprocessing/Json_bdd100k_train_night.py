...
train_imagepath_txtpath = "./" + "train_night_clear.txt"
test_imagepath_txtpath = "./" + "test_night_clear.txt"
# define the path to the directory to which each images's labels (in form of text) are written
train_label_filepath = "./labels/train/" + "night_clear"
test_label_filepath = "./labels/test/" + "night_clear"
