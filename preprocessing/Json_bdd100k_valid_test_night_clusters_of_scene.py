...
### create valid_night_clear_cluster.txt
...
valid_imagepath_txtpath = "./" + "valid_night_clear_" + "cluster" + ".txt"
...
### create test_night_clear_cluster.txt
...
test_imagepath_txtpath = "./" + "test_night_clear_" + "cluster" + ".txt"
...
for image_path in list_train_filepath:
    image_path = 'data/custom/images/test/night_clear/' + image_path[-22:-5] + '.jpg'
    file_imagepath.write(image_path+'\n')
file_imagepath.close()
